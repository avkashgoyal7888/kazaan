<div>
    @push('css')
    <title>Our Services | Kazaan Lifestyle</title>
    <meta name="description" content="Discover the premium travel services offered by Kazaan Lifestyle — including trip planning, hotel bookings, custom packages, and 24/7 travel support for unforgettable journeys.">
    @endpush
            ...
            <div class="row g-4 justify-content-center">
                    ...
                    <div class="blog-item">
                        <div class="blog-img">
                            <div class="blog-img-inner">
                                <img class="img-fluid w-100 rounded-top" src="https://res.cloudinary.com/dmbgfw4bu/image/upload/v1748733603/kazan/pages/kzx15klfhv2wi5lorzbw.jpg" alt="Image">
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="blog-item">
                        <div class="blog-img">
                            <div class="blog-img-inner">
                                <img class="img-fluid w-100 rounded-top" src="https://res.cloudinary.com/dmbgfw4bu/image/upload/v1748733603/kazan/pages/ns88b1jqwh2z2bjhkbg9.jpg" alt="Image">
                            </div>
                        </div>
                        <div class="blog-content border border-top-0 rounded-bottom p-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="blog-item">
                        <div class="blog-img">
                            <div class="blog-img-inner">
                                <img class="img-fluid w-100 rounded-top" src="https://res.cloudinary.com/dmbgfw4bu/image/upload/v1748733603/kazan/pages/wyuevo6ofbe5mcyab32c.jpg" alt="Image">
                            </div>
                        </div>
                        <div class="blog-content border border-top-0 rounded-bottom p-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="blog-item">
                        <div class="blog-img">
                            <div class="blog-img-inner">
                                <img class="img-fluid w-100 rounded-top" src="https://res.cloudinary.com/dmbgfw4bu/image/upload/v1748773841/kazan/pages/odmo9riyxkslpkahbny3.jpg" alt="Image">
                            </div>
                        </div>
                        <div class="blog-content border border-top-0 rounded-bottom p-4">
